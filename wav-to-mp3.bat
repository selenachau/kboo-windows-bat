...
:: -q:a 1 transcode at constant quality as opposed to constant bitrate 1 is 190-250 bitrate range kbit/s
:: -n skips wav files where mp3 file exists with same name
:: full documentation at ffmpeg.org/ffmpeg.html
:: For more detailed discussion on variable vs constant bitrates see https://trac.ffmpeg.org/wiki/Encode/MP3
